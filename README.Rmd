...
The goal of R.package.MhmdJamaal is to make regular expressions more exciting!
...
You can install the development version of R.package.MhmdJamaal from [GitHub](https://github.com/) with:
